...
public interface IOrderServiceClient
{
    ...
    /// <summary>
    /// Gets the items associated with a specific order number.
    /// </summary>
    /// <param name="orderNumber">The human-readable order number.</param>
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    /// <returns>A list of order items.</returns>
    Task<List<OrderItemDto>> GetOrderItemsAsync(string orderNumber, CancellationToken cancellationToken = default);
